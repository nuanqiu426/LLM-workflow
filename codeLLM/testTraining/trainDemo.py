...
#     # model_name = "Llama-3.2-1B-Instruct", # or choose "unsloth/Llama-3.2-1B-Instruct"
...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name = "/workspace/LLM-finetune/codeLLM/huggingface/unsloth/Llama-3.2-1B-Instruct",
    max_seq_length = max_seq_length,
    dtype = dtype,
    load_in_4bit = load_in_4bit,
